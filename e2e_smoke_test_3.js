...
(async () => {
  ...
  try {
    ...
    console.log('2. Navigating to Create Object...');
    await page.goto('https://main.cac-web-app.pages.dev/admin/knowledge/edit?id=new');
    await page.waitForTimeout(2000);
    ...
    page.once('dialog', dialog => dialog.accept('Playwright test edit'));
    await page.click('button[type="submit"]');
    await page.waitForTimeout(2000);
